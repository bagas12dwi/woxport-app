<nav class="navbar navbar-dark navbar-theme-primary px-4 col-12 d-lg-none">
    <a class="navbar-brand me-lg-5" href="{{ url('#') }}">
        <img class="navbar-brand-dark" src="{{ URL::asset('assets/images/light.svg') }}" alt="" />
    </a>
            ...
            <li class="nav-item">
                <a href="{{ url('#') }}" class="nav-link d-flex align-items-center">
                    <span class="sidebar-icon">
                        <img src="{{ URL::asset('assets/images/light.svg') }}" height="20" width="20"
                            alt="Volt Logo">
                    </span>
                    <span class="mt-1 ms-1 sidebar-text">Woxport Admin</span>
                </a>
            </li>
