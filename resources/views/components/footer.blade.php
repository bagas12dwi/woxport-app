    ...
    <footer class="d-flex flex-wrap justify-content-between align-items-center py-3 mt-4">
        <div class="col-md-4 col-12 d-flex align-items-center">
            <a href="/" class="mb-3 me-2 mb-md-0 text-body-secondary text-decoration-none lh-1">
                <img src="{{ URL::asset('assets/images/logo1.png') }}" alt="Bootstrap" height="30">
            </a>
            <span class="mb-3 mb-md-0 text-white text-center text-md-start">&copy; 2023 Woxport, Inc</span>
        </div>
        ...
        <ul class="nav col-md-4 col-12 justify-content-center justify-content-md-end list-unstyled d-flex">
            <li class="ms-3"><a class="text-white" href="https://www.instagram.com/woxport_official/"> <i
                        class="bi bi-instagram fs-3 text-light"></i></a>
            </li>
        </ul>
    </footer>
</div>
